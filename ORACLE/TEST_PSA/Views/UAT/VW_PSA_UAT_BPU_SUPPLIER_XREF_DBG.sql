CREATE OR REPLACE VIEW vw_psa_uat_bpu_supplier_xref_dbg AS
WITH
  ...
  (
    ...
    LEFT JOIN ahmadmin.PurchasedProduct@psa                             pp
...
GRANT SELECT ON vw_psa_uat_bpu_supplier_xref_dbg TO deployer, ods_dml, ahmadmin_read;
