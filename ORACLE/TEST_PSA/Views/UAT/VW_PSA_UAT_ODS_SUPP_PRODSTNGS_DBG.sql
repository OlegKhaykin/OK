CREATE OR REPLACE VIEW vw_psa_uat_ods_supp_prodstngs_dbg AS
WITH
  ...
  (
    ...
    DISTINCT
      ...
      spr.*
    FROM ODS.Supplierproductsettings@psa               spr
...
GRANT SELECT ON vw_psa_uat_ods_supp_prodstngs_dbg TO deployer, ods_dml, ahmadmin_read;
