CREATE OR REPLACE VIEW vw_psa_uat_pprd_tgtpln_dbg AS
WITH
  ...
  (
    ...
    JOIN ahmadmin.PurchasedProduct@psa                                    pp
      ON pp.SupplierID = sup.SupplierID  
    JOIN ahmadmin.PurchasedProductTargetPLN@psa                           ppt
      ON ppt.PurchasedProductID = pp.PurchasedProductID  
  )
...
GRANT SELECT ON vw_psa_uat_pprd_tgtpln_dbg TO deployer, ods_dml;
