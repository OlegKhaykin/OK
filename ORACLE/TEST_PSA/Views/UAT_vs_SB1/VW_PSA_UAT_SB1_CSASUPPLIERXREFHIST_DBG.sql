CREATE OR REPLACE VIEW vw_psa_uat_sb1_csasupplierxrefhist_dbg AS
WITH
  ...
  (
    SELECT --+ materialize
      csxh.*
    FROM vw_psa_plan_sponsor_list                      psl 
    JOIN ods.CSASupplierXrefHist@sb1                   csxh
      ON (csxh.psuid = psl.psuid OR csxh.newpsuid = psl.psuid)
  )
...
GRANT SELECT ON vw_psa_uat_sb1_csasupplierxrefhist_dbg TO deployer, ods_dml;