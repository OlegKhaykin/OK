create or replace view vw_psa_uat_sb1_csasupplierxref_dbg as
WITH
  ...
  (
    SELECT --+ materialize
      csx.*
    FROM vw_psa_plan_sponsor_list                     psl 
    JOIN ods.csasupplierxref@sb1                      csx
      ON csx.psuid = psl.psuid
  )
...
GRANT SELECT ON vw_psa_uat_sb1_csasupplierxref_dbg TO deployer, ods_dml;