CREATE OR REPLACE VIEW vw_psa_uat_sb1_pprdofatrval_xr_dbg AS
WITH
...
SELECT 'PurchasedProdoffngAttrvalXREF : NEW' AS Compare,  n.* FROM (SELECT * FROM new_results) n
UNION ALL
SELECT 'PurchasedProdoffngAttrvalXREF : OLD' AS Compare,  o.* FROM (SELECT * FROM old_results) o;

GRANT SELECT ON vw_psa_uat_sb1_pprdofatrval_xr_dbg TO deployer, ods_dml;
