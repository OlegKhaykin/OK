CREATE OR REPLACE VIEW vw_psa_uat_suppacpkg_xr_dbg AS
WITH
  ...
  (
    ...
    JOIN ahmadmin.PurchasedProduct@psa                                    pp
      ON pp.SupplierID = sup.SupplierID  
    JOIN ahmadmin.SupplierAcctpackageXREF@psa                             scx
      ON scx.AHMsupplierID = sup.AHMsupplierID    
  )
...
GRANT SELECT ON vw_psa_uat_suppacpkg_xr_dbg TO deployer, ods_dml;
