CREATE OR REPLACE VIEW vw_psa_uat_bpu_bplv_xref_dbg AS
WITH
  ...
  (
    ...
    JOIN ahmadmin.CSABPLVXREF@psa                                       cbx
    ...
    JOIN ahmadmin.BenefitProvisionLineValue@psa                         bplv
...
GRANT SELECT ON vw_psa_uat_bpu_bplv_xref_dbg TO deployer, ods_dml, ahmadmin_read;
